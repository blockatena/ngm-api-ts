...
class MetaData {
    ...
    name: string;
    @ApiProperty({ default: 'https://nftstorage.link/ipfs/bafybeihef3pr6kh2yjxdqrur2frw3vzj2nhmhlbkugnmqoqmqcktrhzghe/name1.png' })
    image: string;
...
export class GetSingleNft {
    ...
    price: string;
    @ApiProperty({ default: 'https://ngm-api-tpnng.ondigitalocean.app/metadata/0x8f27D09be98d2583E0322C25C8F2149E4AA2635C/31' })
