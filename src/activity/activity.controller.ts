...
export class ActivityController {
  ...
  @ApiOperation({
    summary: 'This API will gives you Activity of Particular Item',
  })
  @Get(
    'get-item-activity/:contract_address/:token_id/:page_number/:items_per_page',
  )
  async getItemActivity(
    @Param() get_item_activity: GetItemActivity,
  ): Promise<any> {
    try {
